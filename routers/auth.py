...
async def forgotten_password_post(
    ...
    if not user:
        msg = "Email not found"
        return templates.TemplateResponse("password_reset.html", {"request": request, "msg": msg})
...
print (f"Function reference: {forgotten_password_post}")
...
async def reset_password(
    ...
    if new_password != new_password2:
        ...
        return templates.TemplateResponse("password_reset_form.html", {"request": request, "msg": msg, "token": token})
...
async def register_user(request: Request, db: db_dependency, username: str = Form(...),
                        ...
                        password2: str = Form(...), role: str = Form(...)):
